 ...
 *   3. ✓ Done                       → "Back to chat" button → /workspace/map
 *
 * Mounted on /org-admin?firstRun=1. If the user already has an org,
    ...
    <div className="first-run-card">
      ...
      {step === 'done' && (
        <div className="first-run-body first-run-body--done">
          ...
          <a href="/workspace/map" className="first-run-cta" onClick={onComplete}>Back to chat →</a>
        </div>
      )}
    </div>
  );
