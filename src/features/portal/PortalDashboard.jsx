    ...
    return (
      <div key={r.id} className="process-row">
        ...
        <div className="process-actions">
          <a href={'/diagnostic.html?view=' + r.id} className="process-btn process-btn-view">View</a>
          <a href={editUrl} className="process-btn process-btn-edit">Edit</a>
          <button
            type="button"
            className="process-btn process-btn-delete"
  ...
  return (
    <>
        ...
        {tab === 'overview' && (
          <div className="fade-in">
            ...
            <div className="quick-grid">
              <Link to="/diagnostic" className="quick-tile">
              ...
              <a href={'/monitor?email=' + encodeURIComponent(email)} className="quick-tile">
            ...
            <div className="dash-card">
              <div className="dash-card-header">
                ...
                <Link to="/diagnostic" className="dash-card-action">+ New Diagnostic</Link>
              </div>
              <div>
                {loading ? (
      ...
      <footer style={{ padding: '32px 24px', fontSize: '0.76rem', borderTop: '1px solid #e8ecf1', textAlign: 'center', color: 'var(--text-light)' }}>
        <a href="/" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Workflow Partners</a> · Technology-agnostic workflow optimisation
      </footer>
    </>
  );
}
