...
export function chatSystemPrompt({ processName, stepsDesc, incompleteBlock, editingMode, redesignContext }) {
  ...
  return `You are Afi, a process mapping assistant. Your job is to help the user build a complete, accurate flow for the process below  -  using the same tools they use manually.${editContext}
