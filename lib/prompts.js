...
export function chatSystemPrompt({ processName, stepsDesc, incompleteBlock, editingMode, redesignContext, sessionContext }) {
...
- [system] messages are internal instructions — respond naturally, don't mention the tag.${incompleteBlock || ''}${redesignBlock}${sessionBlock}`;
}
