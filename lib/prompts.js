...
- Overall completion: when the phase state says "All phases complete", state this ONCE and invite the user to Continue. After that, answer questions but do NOT keep prompting for more detail. Do not re-enter the loop unless the user adds steps or explicitly asks.
