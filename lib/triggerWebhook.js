...
export async function triggerWebhook(payload, { envSuffix, requestId } = {}) {
  // All outbound n8n/email webhooks disabled. Re-enable by removing this block.
  void payload; void envSuffix; void requestId;
  return { sent: false, reason: 'webhooks-disabled' };
