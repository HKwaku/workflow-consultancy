...
export const addStepTool = tool(
  ...
  },
  {
    ...
    schema: z.object({
      ...
      parallel: z.boolean().optional().describe('If isDecision: true = AND/parallel gateway (all branches run simultaneously)'),
      inclusive: z.boolean().optional().describe('If isDecision: true = OR/inclusive gateway (one or more branches run based on conditions)'),
...
export const updateStepTool = tool(
  ...
  },
  {
    ...
    schema: z.object({
      ...
      parallel: z.boolean().optional().describe('true = AND/parallel gateway (all branches run)'),
      inclusive: z.boolean().optional().describe('true = OR/inclusive gateway (one or more branches run)'),
